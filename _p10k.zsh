# Generated by Powerlevel10k configuration wizard on 2020-03-29 at 19:02 CDT.
...
# time, slanted separators, slanted heads, slanted tails, 2 lines, solid, no frame,
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=249 # custom grey path
  ...
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=250 # custom grey cwd
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      # local      clean='%33F'   # custom blue foreground
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='kubectl|helm|kubens|kubectx|oc|istioctl|kogito|stern'
  ...
  POWERLEVEL9K_KUBECONTEXT_DEFAULT_CONTENT_EXPANSION+='${P9K_KUBECONTEXT_NAME:-${P9K_KUBECONTEXT_NAMESPACE}}'
