# Generated by Powerlevel10k configuration wizard on 2020-03-27 at 18:32 CDT.
...
# time, angled separators, slanted heads, blurred tails, 2 lines, solid, no frame,
...
() {
  ...
  if [[ $POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_CHAR != ' ' ]]; then
    ...
    typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_FOREGROUND=242 ### CONFIRM not 238
